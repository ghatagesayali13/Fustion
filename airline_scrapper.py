...
get_ipython().run_line_magic('cd',
                             '"C:\\\\Users\\\\harsh\\\\OneDrive\\\\Desktop\\\\ISB\\\\Data Collection\\\\Assignment"')
driver = wb.Chrome("C:\\Users\\harsh\\OneDrive\\Desktop\\ISB\\Data Collection\\Assignment\\chromedriver.exe")
...
for a, b, c in zip(day, month, year):
    driver.get(
        "https://www.makemytrip.com/flight/search?tripType=O&itinerary=DEL-BOM-{}/{}/{}&paxType=A-1_C-0_I-0&cabinClass=E&sTime=1597828876664&forwardFlowRequired=true".format(
            a, b, c))
    time.sleep(15)
    ...
    df = pd.DataFrame(
        {'Date': Date, "Airline": FlightName, "From City": Fromcity, "To City": Tocity, "Departure Time": Deptime,
         "Arrival Time": Arrtime, "Flight Duration": Duration, "Price": Price})
...
Flight_Prices = Flight_Prices[
    (Flight_Prices['Departure Time'] >= '15:00') & (Flight_Prices['Departure Time'] <= '18:00')]
Flight_Prices
